...
<head>
    ...
    <title>Eletrônicos | Desapeguei</title>
...
<div class="pagina-busca">
    <div class="container">
        <h1 class="titulo">Eletrônicos</h1>

        <div class="filtros">
            <a href="eletronicos.php" class="btn-filtro <?= empty($_GET['subcategoria']) ? 'ativo' : '' ?>">Todos</a>
            <a href="eletronicos.php?subcategoria=celular" class="btn-filtro <?= ($_GET['subcategoria'] ?? '') === 'celular' ? 'ativo' : '' ?>">Celulares</a>
            <a href="eletronicos.php?subcategoria=notebook" class="btn-filtro <?= ($_GET['subcategoria'] ?? '') === 'notebook' ? 'ativo' : '' ?>">Notebook</a>
            <a href="eletronicos.php?subcategoria=tv" class="btn-filtro <?= ($_GET['subcategoria'] ?? '') === 'tv' ? 'ativo' : '' ?>">TV</a>
            <a href="eletronicos.php?subcategoria=fone" class="btn-filtro <?= ($_GET['subcategoria'] ?? '') === 'fone' ? 'ativo' : '' ?>">Fone</a>
            <a href="eletronicos.php?subcategoria=acessorios" class="btn-filtro <?= ($_GET['subcategoria'] ?? '') === 'acessorios' ? 'ativo' : '' ?>">Acessórios</a>
            <a href="eletronicos.php?subcategoria=outro" class="btn-filtro <?= ($_GET['subcategoria'] ?? '') === 'outro' ? 'ativo' : '' ?>">Outro</a>
        </div>
