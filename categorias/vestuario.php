...
<body>
    ...
    <div class="container">
        ...
        <div class="filtros">
            ...
            <a href="vestuario.php?subcategoria=camisa" class="btn-filtro <?= ($_GET['subcategoria'] ?? '') === 'camisa' ? 'ativo' : '' ?>">Camisas</a>
            <a href="vestuario.php?subcategoria=vestido" class="btn-filtro <?= ($_GET['subcategoria'] ?? '') === 'vestido' ? 'ativo' : '' ?>">Vestidos</a>
            <a href="vestuario.php?subcategoria=jaqueta" class="btn-filtro <?= ($_GET['subcategoria'] ?? '') === 'jaqueta' ? 'ativo' : '' ?>">Jaquetas</a>
            <a href="vestuario.php?subcategoria=calca" class="btn-filtro <?= ($_GET['subcategoria'] ?? '') === 'calca' ? 'ativo' : '' ?>">Calças</a>
            <a href="vestuario.php?subcategoria=short" class="btn-filtro <?= ($_GET['subcategoria'] ?? '') === 'short' ? 'ativo' : '' ?>">Shorts</a>
        </div>
