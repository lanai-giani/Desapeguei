...
<div class="pagina-busca">
    <div class="container">
        <h1 class="titulo-categoria">Calçados</h1>

        <div class="filtros">
            <a href="calcados.php" class="btn-filtro <?= empty($_GET['subcategoria']) ? 'ativo' : '' ?>">Todos</a>
            <a href="calcados.php?subcategoria=chinela" class="btn-filtro <?= ($_GET['subcategoria'] ?? '') === 'chinela' ? 'ativo' : '' ?>">Chinelos</a>
            <a href="calcados.php?subcategoria=bota" class="btn-filtro <?= ($_GET['subcategoria'] ?? '') === 'bota' ? 'ativo' : '' ?>">Botas</a>
            <a href="calcados.php?subcategoria=salto" class="btn-filtro <?= ($_GET['subcategoria'] ?? '') === 'salto' ? 'ativo' : '' ?>">Saltos</a>
            <a href="calcados.php?subcategoria=tenis" class="btn-filtro <?= ($_GET['subcategoria'] ?? '') === 'tenis' ? 'ativo' : '' ?>">Tênis</a>
            <a href="calcados.php?subcategoria=sapatilha" class="btn-filtro <?= ($_GET['subcategoria'] ?? '') === 'sapatilha' ? 'ativo' : '' ?>">Sapatilha</a>
            <a href="calcados.php?subcategoria=outro" class="btn-filtro <?= ($_GET['subcategoria'] ?? '') === 'outro' ? 'ativo' : '' ?>">Outro</a>
        </div>
