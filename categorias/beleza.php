...
<body class="vender_style">
    ...
    <div class="container">
        ...
        <div class="filtros">
            ...
            <a href="beleza.php?subcategoria=cabelo" class="btn-filtro <?= ($_GET['subcategoria'] ?? '') === 'cabelo' ? 'ativo' : '' ?>">Cabelo</a>
            <a href="beleza.php?subcategoria=perfume" class="btn-filtro <?= ($_GET['subcategoria'] ?? '') === 'perfume' ? 'ativo' : '' ?>">Perfume</a>
            <a href="beleza.php?subcategoria=skincare" class="btn-filtro <?= ($_GET['subcategoria'] ?? '') === 'skincare' ? 'ativo' : '' ?>">Skincare</a>
            <a href="beleza.php?subcategoria=outro" class="btn-filtro <?= ($_GET['subcategoria'] ?? '') === 'outro' ? 'ativo' : '' ?>">Outro</a>
