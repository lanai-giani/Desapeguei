...
<div class="pagina-busca">
    <div class="container">
        <h1 class="titulo-categoria">Bolsas</h1>

        <div class="filtros">
            <a href="bolsas.php" class="btn-filtro <?= empty($_GET['subcategoria']) ? 'ativo' : '' ?>">Todos</a>
            <a href="bolsas.php?subcategoria=mochila" class="btn-filtro <?= ($_GET['subcategoria'] ?? '') === 'mochila' ? 'ativo' : '' ?>">Mochila</a>
            <a href="bolsas.php?subcategoria=bolsa_de_mao" class="btn-filtro <?= ($_GET['subcategoria'] ?? '') === 'bolsa_de_mao' ? 'ativo' : '' ?>">Bolsa de mão</a>
            <a href="bolsas.php?subcategoria=bolsa_transversal" class="btn-filtro <?= ($_GET['subcategoria'] ?? '') === 'bolsa_transversal' ? 'ativo' : '' ?>">Bolsa transversal</a>
            <a href="bolsas.php?subcategoria=carteira" class="btn-filtro <?= ($_GET['subcategoria'] ?? '') === 'carteira' ? 'ativo' : '' ?>">Carteira</a>
