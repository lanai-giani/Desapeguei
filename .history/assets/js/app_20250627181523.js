...
document.addEventListener('DOMContentLoaded', function () {
    const subcategoriasPorCategoria = {
        'vestuario': ['Camisa', 'Vestido', 'Jaqueta', 'Calça', 'Short','Saia'],
        ...
        'acessorios': ['Relógio', 'Óculos', 'Brinco', 'Colar','Cinto','Joias'],
        'kids': ['Macacão', 'Brinquedos', 'Calçados Infantis','Vestido', 'Calça','Blusa','Casaco','Body']
    };
