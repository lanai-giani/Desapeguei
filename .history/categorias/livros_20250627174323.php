...
<body>
    ...
    <div class="container">
        ...
        <div class="filtros">
            ...
            <a href="livros.php?subcategoria=ficcao" class="btn-filtro <?= ($_GET['subcategoria'] ?? '') === 'ficcao' ? 'ativo' : '' ?>">ficcao</a>
            <a href="livros.php?subcategoria=didatico" class="btn-filtro <?= ($_GET['subcategoria'] ?? '') === 'didatico' ? 'ativo' : '' ?>">didatico</a>
            <a href="livros.php?subcategoria=hq" class="btn-filtro <?= ($_GET['subcategoria'] ?? '') === 'calça' ? 'hq' : '' ?>">HQ</a>
